...
public class TaskOri {
	...
	public TaskOri(long id) {
		super();
		this.id = id;
	}

	public TaskOri(long id, String status, String routingCurrent, String role, String routingClass) {
		super();
	...
	public String toString() {
		return "TaskOri [id=" + id + ", routingNumber=" + routingNumber + ", status=" + status + ", role=" + role
